  ...
  return (
    <div className="w-[95%] lg:w-9/12 mx-auto my-5 lg:my-30 gap-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <form onSubmit={handleRatingSubmit}>
            <textarea
              ...
              {...(!myRatings
                ...
                : {
                    defaultValue:
                      myRatings?.description || "No Description added",
                  })}
              readOnly={!!myRatings}
            ></textarea>
      ...
      <div className="hidden lg:flex flex-col ml-0 lg:ml-5">
        {/* <Link className="text-white font-semibold bg-secondary py-3.5 rounded-sm px-[30px] hover:bg-primary duration-400 cursor-pointer text-center flex items-center justify-center">
          <span className="flex gap-2 items-center">
            <span>
              <FaArrowLeft />
            </span>
