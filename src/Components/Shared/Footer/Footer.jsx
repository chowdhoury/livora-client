      ...
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 bg-base-200 w-[95%] lg:w-9/12 lg:mx-auto px-10 py-8 rounded-2xl items-center absolute left-1/2  -translate-x-1/2 -translate-y-1/2 z-20">
        <div className="flex-1">
          ...
          <p className="text-secondary-content text-center lg:text-left">
            Get helpful updates and insights sent straight to your inbox.
          </p>
        </div>
        <div className="flex-1 flex">
          <input
            className="bg-base-100 w-full px-4 py-4 h-12 rounded-l-sm focus:outline-none"
            type="email"
            name=""
            id=""
            placeholder="Enter your email"
          />
          <button className="bg-secondary text-white px-6 py-4 h-12 rounded-r-sm hover:bg-primary duration-400 flex items-center justify-center">
            <span>Subscribe</span>
          </button>
        </div>
      </div>
